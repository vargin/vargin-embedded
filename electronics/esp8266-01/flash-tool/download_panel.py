...
class Panel2(wx.Panel):
    def _init_ctrls(self, prnt,position,label):#,p_pos):
        ...
        self.choice_ComPort = wx.Choice(choices=["COM1", "COM2", "COM3", "COM4",
              "COM5", "COM6", "COM7", "COM8", "COM9"], id=wxID_PANEL2CHOICE_COMPORT,
        ...
        self.choice_Baudrate = wx.Choice(choices=['115200', '230400', '345600',
    ...
    def __init__(self, parent,position,label,num):#, pos):#id, pos, size, style, name):
        self.frame = parent
        self.num = num
        ...
        self.ESP_FDL = et.ESPROM(parent,6,115200)
